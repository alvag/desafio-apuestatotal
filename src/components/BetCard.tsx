...
const BetCard: React.FC<BetCardProps> = ({ bet }) => {
    ...
    return (
        <div className="bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg hover:scale-105 w-full">
            ...
            {getStatusText(bet.status)}
                ...
                <div className="mt-4 text-right">
                    <Link
                        to={`/bet/${bet.game}`}
                        className="inline-flex items-center text-sm bg-gray-600 hover:bg-gray-700 text-white font-medium py-1 px-3 rounded transition duration-300"
                    >
                        Ver detalle
